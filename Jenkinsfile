    ...
    stage('Deploy develop to Artifactory') {
      ...
      steps {
        rtUpload(
          ...
          "files": [
            {
              "pattern": "dist/nhsd-datadictionary-orchestration-*.tgz",
              "target": "artifacts-snapshots/mauroDataMapper/nhsd-datadictionary-orchestration/"
            }
         ]
    }''',
          )
      ...
      steps {
        rtUpload(
          ...
          "files": [
            {
              "pattern": "dist/nhsd-datadictionary-orchestration-*.tgz",
              "target": "artifacts/mauroDataMapper/nhsd-datadictionary-orchestration/"
            }
         ]
    }''',
          )
